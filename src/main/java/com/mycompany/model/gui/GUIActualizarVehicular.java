 ...
 */
public class GUIActualizarVehicular extends javax.swing.JFrame {

    /**
     * Creates new form GUIActualizarVehicular
     */
    public GUIActualizarVehicular() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnActualizarVeh = new javax.swing.JButton();
        btnBuscar = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("GUI Actualizar Vehicular");
        ...
        btnActualizarVeh.setText("Actualizar Prestamo Vehicular");
        btnActualizarVeh.setEnabled(false);
        btnActualizarVeh.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnActualizarVehActionPerformed(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtValor, javax.swing.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE))))
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        if (txtIdVeh.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "El Campo de ID del Préstamo es obligatorio");
            return;
        }
        try {
            Prestamo prestamo = ServicioPrestamo.getInstance().buscarPrestamo(Integer.parseInt(txtIdVeh.getText()));
            if (prestamo != null) {
                if (prestamo instanceof PrestamoVehicular) {
                    ...
                    btnActualizarVeh.setEnabled(true);
                } else {
                    JOptionPane.showMessageDialog(this, "El ID ingresado pertenece a un Préstamo Hipotecario.");
                    btnActualizarVeh.setEnabled(false);
                }
            } else {
    ...
    private void btnActualizarVehActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarVehActionPerformed
        ...
        try {
            int id = Integer.parseInt(txtIdVeh.getText());
            ...
            if (centinela) {
                ...
                JOptionPane.showMessageDialog(this, "Préstamo Vehicular Actualizado con Éxito");
                txtIdVeh.setText("");
                txtMonto.setText("");
                txtPlazo.setText("");
                txtValor.setText("");
        ...
        }    }//GEN-LAST:event_btnActualizarVehActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIActualizarVehicular.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIActualizarVehicular().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnActualizarVeh;
